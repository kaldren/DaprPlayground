...
$daprConfigContent = $daprConfigContent -replace "STORAGE_ACCOUNT_NAME", $storageAccountName
$daprConfigContent = $daprConfigContent -replace "STORAGE_ACCOUNT_CONTAINER_NAME", $containerName
